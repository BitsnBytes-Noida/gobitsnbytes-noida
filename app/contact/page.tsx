...
import { Mail, MapPin, Clock, Loader2, Github, Instagram } from "lucide-react";
    ...
    <>
          ...
          <div className="px-6 py-12 md:py-20 sm:px-10 lg:px-16 text-center">
            <div className="flex flex-col items-center gap-6">
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-medium">
                Hackathons, workshops, or anything that gets teens building in
                Noida.
              </p>
            </div>
          </div>
      ...
      <main className="relative z-10 bg-transparent">
        <PageSection
          ...
          description="Schools, sponsors, mentors, students. Drop a note, we'll get back to you."
        >
