    ...
    <PageWrapper>
      <main className="flex min-h-screen items-center justify-center px-6">
        <div className="max-w-3xl text-center">
          <p className="font-mono text-sm uppercase tracking-[0.3em] text-purple-300">
            ERROR 404
          </p>
          ...
          <div className="mx-auto mt-10 max-w-xl overflow-hidden rounded-2xl border border-purple-500/20 bg-black/60 text-left backdrop-blur">
