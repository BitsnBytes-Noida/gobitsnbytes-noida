        ...
        <div className="relative z-10 w-full mx-auto max-w-6xl px-4 sm:px-6">
          <div className="mx-auto w-full max-w-[860px] min-h-[460px] md:min-h-[500px] px-6 py-12 md:py-20 sm:px-10 lg:px-16 text-center flex items-center justify-center">
            <div className="flex flex-col items-center gap-6">
              ...
              >
                Events across <br className="hidden sm:block" /> the network
              </h1>
              <p className="max-w-2xl text-base sm:text-lg md:text-xl text-white/85 font-medium leading-relaxed">
                Hackathons, workshops, and meetups run by Bits&Bytes forks
                across India. Noida events coming soon.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  <div className="prose prose-invert max-w-none text-white/80 space-y-6 lg:col-span-2">
                    <div>
                      ...
                      <p>
                        We hosted <strong>Lucknow Build Guild</strong>, a free
                        hardware workshop and meetup on{" "}
                        <strong>19 April</strong> at{" "}
                        <strong>SureStay by Best Western</strong>. The event was
                        designed to help participants explore hands-on hardware
                        building, connect with like-minded builders, and learn
                        through community-driven sessions.
                      </p>
                    </div>

                    <div>
                      <h2 className="text-xl font-bold text-white mb-2">
                        What the meetup focused on
                      </h2>
                      <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li>
                          Community networking with local tech enthusiasts.
                        </li>
                        <li>
                          Open peer learning with an in-person builder crowd.
                        </li>
                      </ul>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  <div className="prose prose-invert max-w-none text-white/80 space-y-6 lg:col-span-2">
                    <div>
                      ...
                      <p>
                        <strong>GitHub Copilot Dev Days</strong> was a community
                        developer event in Lucknow that brought together
                        students, developers, and technology enthusiasts to
                        explore how AI-assisted development works in real
                        projects.
                      </p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  <div className="prose prose-invert max-w-none text-white/80 space-y-6 lg:col-span-2">
                    <div>
                      ...
                      <p>
                        <strong>Execron 1.0</strong> was an AI Hackathon &
                        Workshop designed for students in{" "}
                        <strong>Classes 9–12</strong>. Held in collaboration
                        with <strong>TechKriti '26, IIT Kanpur</strong>, the
                        event featured a 4-hour hands-on tech workshop followed
                    ...
                    <div>
                      ...
                      <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li>
                          Full access to the broader TechKriti '26 festival
                          experiences (mega hackathons, pro shows, robotics
                          expo).
                        </li>
                      </ul>
                    </div>
